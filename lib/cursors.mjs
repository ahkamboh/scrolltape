...
const BUILTIN = {
  "white-pointer": { file: "white-pointer.svg", width: 32, height: 32, origin: "4px 4px" },
  "mac-hand": { file: "mac-hand.svg", width: 36, height: 36, origin: "14px 8px" },
  "cute-paw": { file: "cute-paw.svg", width: 48, height: 48, origin: "8px 6px" },
  "brand-dot": { file: "brand-dot.svg", width: 28, height: 28, origin: "14px 14px" },
};

export async function getCursorMarkup(config) {
  let svg;
  let meta = BUILTIN[config.cursor] ?? BUILTIN["white-pointer"];
