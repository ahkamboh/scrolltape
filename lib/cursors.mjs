...
(() => {
  ...
  // Keep the demo on the page: a real click on a link/CTA would navigate away
  // and break a one-page recording. Block link navigation, new tabs and submits,
  // so scrolltape can hover + click real buttons safely.
